...
vars = {
  ...
  'skia_revision': '81c86e8608c252c17af2ee63be70dd1576a5ed3d',
...
deps = {
  ...
  'src/third_party/harfbuzz':
   Var('github_git') + '/harfbuzz/harfbuzz.git' + '@' + 'e8b364b86023731e0416ab4eb433467c4b7a0ec2',
     ...
     'packages': [
       {
        ...
        'version': 'iK9xdlMLDiH-cDa1f82jz6cNMcMn-DdAP3tCu9xClc0C'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
